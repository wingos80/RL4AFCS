    ...
    def train(self, can_stop=True):
        for episode in range(self.num_episodes):
            ...
            for step in range(num_steps):
                ...
                next_state, reward, done, info, _ = env.step(received_action)
            ...
            print(f'Episode: {episode}\t|| Reward: {reward_for_episode}\t|| Avg Reward: {last_rewards_mean}\t|| Epsilon: {self.epsilon}')

            self.ax.clear()
            self.ax.plot(self.rewards_list)
...
def test_already_trained_model(trained_model):
    ...
    for test_episode in range(num_test_episode):
        ...
        for step in range(step_count):
            ...
            new_state, reward, done, info, _ = env.step(selected_action)
        ...
        print(f'Episode: {test_episode}\t|| Reward: {reward_for_episode}')
